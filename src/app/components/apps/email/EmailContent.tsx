...
const EmailContent = () => {
  ...
  const { selectedEmail, deleteEmail, toggleStar, toggleImportant, setSelectedEmail }: any =
      ...
      <Box p={3}>
        ...
        <Box display="flex" alignItems="center" sx={{ pb: 3 }}>
          ...
          <Box sx={{ ml: 2 }}>
            ...
            <Typography variant="body2" color='textSecondary'>{selectedEmail.To}</Typography>
          </Box>
          <Chip
                  ...
                  (<Grid
                    ...
                    <Stack direction="row" gap={2} mt={2}>
                      ...
                      <Box mr={'auto'}>
                        ...
                        <Typography variant="body2" color='textSecondary'>{attach.fileSize}</Typography>
                      </Box>
                    </Stack>
                  </Grid>)
                );
